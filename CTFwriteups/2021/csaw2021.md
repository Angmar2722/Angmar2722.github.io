...
Basic buffer overflow attack which would overwrite the return address to return to a function which calls `\bin\sh` which would allows us to print the flag.
