...
Now that we have recovered <i>S</i>, we can solve a pair of linear equations simultaneously as <i>S = P + Q - 1</i> and <i>N = P * Q</i> in order to recover the prime factors <i>P</i> and <i>Q</i>.
