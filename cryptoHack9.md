...
So we have the ciphertext, exponent and modulus. I used the same website as the previous two challenges to get the prime factors (both are the same in this case as stated in the challenge).

So after that I used basically the same script as the last challenge to get the flag :
